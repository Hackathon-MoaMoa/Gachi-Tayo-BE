...
## 프로젝트 컨셉
![차별점(장점)1](https://user-images.githubusercontent.com/75000923/175471367-d2b573db-2c0c-47ce-b439-63303dfcaea9.png)
...
* 입력한 휴대폰 번호로 문자가 전송되고, 올바른 인증 번호 입력해야 회원 가입 가능
